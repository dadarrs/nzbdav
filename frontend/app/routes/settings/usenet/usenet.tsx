                        ...
                        <div className={`${styles["form-group"]} ${styles["full-width"]}`}>
                            ...
                            <div style={{ marginTop: '8px', opacity: 0.7, fontSize: '0.85em' }}>
                                {pipeliningMasterEnabled
                                    ? "Pipelining sends many STAT checks at once for faster health checks. For backup providers, this tickbox also opts the provider into carrying health checks when “Use Backup Providers for health checks” is enabled on the SABnzbd tab — STAT commands download no article data, though their protocol traffic can count toward block quotas (~0.7 MB per 10 GB of content checked). Test that this provider handles it correctly before enabling."
