...
public class ConfigManager
{
    ...
    /// <summary>
    /// By default, health checks use every connection made available by the eligible providers.
    /// Operators can set a lower, separate ceiling without changing provider connection limits.
    /// Connection-attempt throttling and circuit breakers bound failure storms independently.
    /// </summary>
    public int GetHealthCheckConcurrency(bool useBackupProviders)
    {
        ...
        var requested = configured != null ? int.Parse(configured) : available;
