...
public class ContextualCancellationTokenSource : IDisposable
{
    ...
    public static ContextualCancellationTokenSource CreateLinkedTokenSource(CancellationToken linkedToken)
    {
        ...
        contextualCts.SetContext(linkedToken.GetContext<BackgroundHealthCheckContext>());
    ...
    )
    {
        ...
        contextualCts.SetContext(linkedToken1.GetContext<BackgroundHealthCheckContext>());
        contextualCts.SetContext(linkedToken2.GetContext<BackgroundHealthCheckContext>());
        return contextualCts;
    }
